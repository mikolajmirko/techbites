<div class="w-full bg-dark">
  ...
  <footer class="max-w-7xl mx-auto px-4 sm:px-6 py-8" aria-label="{{{ __('Website footer', 'tb') }}}">
    ...
    <div id="goUpButton" class="fixed right-4 bottom-4 -bottom-12" aria-hidden="true" x-data="{ goUpOpen: false }">
      <button x-on:mouseenter="goUpOpen = true" x-on:mouseleave="goUpOpen = false" x-on:focusin="goUpOpen = true" x-on:focusout="goUpOpen = false" type="button" class="rounded-md p-2 mr-2 inline-flex items-center justify-center text-white bg-primary dark:bg-accent hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white" tabindex="-1">
